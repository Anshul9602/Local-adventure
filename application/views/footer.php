...
<footer id="footer" class="desk footer position-relative">
  ...
  <div class="footer-content" style="position: absolute;">
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="row mob_pp" style="align-items: center;padding-right:24%;padding-left:3%;">
          <div class="row" style="height: auto;">
            ...
            <div class=" col-md-4 col-6 footer-links  text-center" style="">
              <img src="assets/img/logo_f.png" alt="" width="100%" style="max-width: 150px;">
              <p class="text-white mt-3" style="padding-left: 10px;font-size:14px;">Phone : +91 9509712510</p>
              ...
              <div class="social-links d-flex mt-3 text-center" style="padding-left: 10px;    justify-content: center;">
...
<!-- ======= Footer ======= -->
<footer id="footer1" class="mob footer position-relative" style="background-image: url('assets/img/footer.png');">

  <div class="footer-content">
    <div class="row">
      <div class="col-md-3 col-3"></div>
      <div class="col-md-9 col-9">
        <div class="row" style="align-items: start;justify-content: space-around;">

          <div class="col-6 footer-links" style="    border-right: 1px solid #ffffff59;">
            <h4>Resources</h4>
            <ul>
              <li><a href="<?php echo base_url(''); ?>">Download</a></li>
              <li><a href="<?php echo base_url(''); ?>">Help Center</a></li>
          ...
          <div class="col-5" style="height: 1px;    background: #ffffff59;"></div>
          <div class="col-5" style="height: 1px;    background: #ffffff59;"></div>
          <div class="col-md-3 col-6 footer-links" style="    border-right: 1px solid #ffffff59;">
            <h4>Company</h4>
            <ul>
              <li><a href="<?php echo base_url(''); ?>">Travelling</a></li>
              <li><a href="<?php echo base_url('About'); ?>">About </a></li>
          ...
          <div class=" col-md-3 col-6 footer-links">
            ...
            <img class="mob" src="assets/img/logo_f.png" alt="" width="100%" style="max-width: 80px;">

            <div class="social-links d-flex mt-md-3 mt-1 " style="padding-left: 0px;">
          ...
          <div class=" col-12 footer-links">
            ...
            <p class="text-white" style="font-size: 8px !important;">Phone : +91 9509712510</p>
            <p class="text-white"style="font-size: 8px !important;">Email : <a href="mailto:info@localadventures.in" class="text-white">info@localadventures.in</a></p>
          </div><!-- End footer links column-->
